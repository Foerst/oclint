...
class NYBlockCaptureCheckRule : public AbstractASTVisitorRule<NYBlockCaptureCheckRule>
{
    
public:
    
    NYBlockCaptureCheckRule()
    {
    ...
    {
        return "NYBlockCaptureCheckRule";
    }
...
static RuleSet rules(new NYBlockCaptureCheckRule());
